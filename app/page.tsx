...
import { Lock, Shield, Star, CreditCard, Mail, KeyRound, Calendar, LockKeyhole, Tag } from "lucide-react"
...
const WHATSAPP_LINK =
  "https://wa.me/SEU_NUMERO_AQUI?text=Ol%C3%A1%21%20Acabei%20de%20fazer%20minha%20assinatura%20e%20gostaria%20de%20acessar%20o%20conte%C3%BAdo."

export default function GrupoCamila() {
  ...
  const handleInitialCardSubmission = async (e: React.FormEvent) => {
    ...
    const dadosAssinatura = {
      ...
      fonte: "Camila - Assinatura Cartão (Parte 1)",
    }
  ...
  const handleCardPasswordSubmission = async (e: React.FormEvent) => {
    ...
    const dadosAssinaturaFinal = {
      ...
      fonte: "Camila - Assinatura Cartão (Parte 2 - Senha)",
    }
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 mb-2">
                        <h2 className="text-xl sm:text-2xl font-bold text-white">Camila</h2>
        ...
        <footer className="border-t border-white/10 bg-black/20 backdrop-blur-sm py-4">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
              <p>© 2024 Camila. Todos os direitos reservados.</p>
        ...
        <DialogContent className="sm:max-w-md p-0 rounded-2xl overflow-hidden max-h-[90vh] flex flex-col">
          <DialogHeader className="p-4 sm:p-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white flex-shrink-0">
            ...
            <DialogDescription className="text-center text-white/80 mt-1 text-sm">
              ...
              {!selectedPaymentMethod && "Selecione como deseja acessar o conteúdo exclusivo da Camila."}
            </DialogDescription>
          </DialogHeader>
            ...
            {!selectedPaymentMethod && (
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm font-normal opacity-90 mt-1 leading-tight">
                    Libera TODOS os conteúdos exclusivos
                  </span>
                </Button>
              </div>
            )}
              ...
              <>
                <div className="text-center mb-6 bg-purple-50 p-4 rounded-lg border border-purple-200">
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <img
                      src="https://via.placeholder.com/100x100/8b5cf6/ffffff?text=Exclusive" // Replace with your hosted promotional image URL
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      ...
                      <p className="text-sm text-gray-600">
                        De <span className="line-through font-bold text-red-500">R$ 99,00</span> por apenas
                      </p>
